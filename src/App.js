...
import PartList from "./components/avatarPartList";
...
function App() {
    ...
    const randomize = () => {
        setBody(`${bodyList.url}${randomItem(bodyList.total)}.png`);
        setEyes(`${eyesList.url}${randomItem(eyesList.total)}.png`);
        setHair(`${hairList.url}${randomItem(hairList.total)}.png`);
        setMouth(`${mouthList.url}${randomItem(mouthList.total)}.png`);
        setEyesbrows(`${eyesbrowsList.url}${randomItem(eyesbrowsList.total)}.png`);
        setGlasse(`${glassList.url}${randomItem(glassList.total)}.png`);
        setClothingL1(`${clothingL1List.url}${randomItem(clothingL1List.total)}.png`);
        seClothingL2(`${clothingL2List.url}${randomItem(clothingL2List.total)}.png`);
        setClothingL3(`${clothingL3List.url}${randomItem(clothingL3List.total)}.png`);
    };
